...
public class CourseDaoImpl implements CourseDao {
	...
	private static final String CREATE_COURSE = "INSERT INTO COURSE_INFORMATION (COURSE_ID, COURSE_NAME, COURSE_TRAINER_NAME, COURSE_DURATION, "
			+ " COURSE_TOTAL_SEATS, COURSE_FEES, COURSE_DESCRIPTION, COURSE_START_DATE, COURSE_END_DATE ) "
			+ " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ? ) ";

	private static final String READ_ALL_COURSES = "SELECT COURSE_ID, COURSE_NAME, COURSE_TRAINER_NAME, COURSE_DURATION, "
			+ " COURSE_TOTAL_SEATS, COURSE_FEES, COURSE_DESCRIPTION, COURSE_START_DATE, COURSE_END_DATE FROM COURSE_INFORMATION ";

	private static final String UPDATE_COURSE_BY_ID = "UPDATE COURSE_INFORMATION SET COURSE_NAME = ?, COURSE_TRAINER_NAME = ?, COURSE_DURATION = ?,"
			+ " COURSE_TOTAL_SEATS = ?, COURSE_FEES = ?, COURSE_DESCRIPTION = ?, COURSE_START_DATE = ?, COURSE_END_DATE = ? WHERE COURSE_ID = ? ";

	private static final String DELETE_BY_ID = "DELETE FROM COURSE_INFORMATION WHERE COURSE_ID = ? ";
